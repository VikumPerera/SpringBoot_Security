...
import com.springboot.demo.exception.InvalidInputExceptionJson;

/**
 * Created by vikum.perera on 06/05/2022.
 */
@Component
public class SaasUtil {
    ...
    public static boolean isValidStartDateAndEndDate(LocalDateTime startDate, LocalDateTime endDate, ResponseDTO response) {
        ...
        // https://kognitiv.atlassian.net/wiki/spaces/KPS/pages/297899425793/APIM+API+specs#Error-Code-List
